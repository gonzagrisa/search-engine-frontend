...
export class TableFormComponent implements OnInit {
  ...
  refreshControls(){
    console.log(`
      ...
      RANGE: ${(this.page - 1) * this.pageSize, (this.page - 1) * this.pageSize + this.pageSize}
      DESDE: ${(this.page - 1) * this.pageSize}
      HASTA: ${(this.page - 1) * this.pageSize + this.pageSize}
    `)
    this.pageControls = this.form.controls.slice((this.page - 1) * this.pageSize, (this.page - 1) * this.pageSize + this.pageSize);
  }
